"""
Docstring for LeetCode-Easy.Arrarys.11-26.RemoveDuplicatesfromSortedArray
...
# "I used the two-pointer approach with one pointer (left) tracking the position to place the next 
# unique element and another (right) iterating through the array. Whenever a new unique value is 
