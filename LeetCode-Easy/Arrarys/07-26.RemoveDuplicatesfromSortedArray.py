"""
Docstring for LeetCode-Easy.Arrarys.7-26.Remove Duplicates from Sorted Array
...
# For removing duplicates in a sorted array in-place, the two-pointer (slow/fast) technique is the gold 
# standard. It works because duplicates are adjacent in sorted order, so we only need to track the last 
# placed unique element and copy the next different one forward.
