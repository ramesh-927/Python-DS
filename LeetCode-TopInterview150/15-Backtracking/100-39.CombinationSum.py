...
class Solution:
    def combinationSum(self, candidates, target):
        ...
        def backtrack(i, curr, total):
            ...
            # Don't choose current number — move to next
            curr.pop()
...
if __name__== "__main__":
    ...
    candidates = [2,3,5]
    target = 8
    out = sol.combinationSum(candidates, target)
    print(f"Combination sum of '{candidates}' and '{target}' is permutation of : ", out)

# | Complexity | Value       | Why                                           |
# | ---------- | ----------- | --------------------------------------------- |
# | Time       | Exponential | Explore many subsets                          |
# | Space      | O(target)   | Max recursion depth due to repeated additions |
